    ...
    <PageWrapper pageTitle="TransitMatters Dashboard">
      <div
        className={classNames(
          isMobile && 'pb-32',
          'relative flex h-screen w-full flex-col items-center justify-center gap-4 overflow-x-hidden overflow-y-visible bg-stone-700'
        )}
      >
        <div className="relative z-10 flex w-5/6 flex-col items-center gap-y-4 rounded-lg bg-black bg-opacity-40 px-4 py-4 backdrop-blur-sm md:p-8 md:py-12 lg:w-3/4 xl:w-1/2">
      ...
      <div
        className="relative z-10 h-full bg-stone-700 bg-opacity-80 pb-20 pt-12 backdrop-blur-lg md:py-20"
        id="charts"
      >
        <LandingCharts />
      </div>
