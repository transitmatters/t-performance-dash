            ...
            {({ open, close }) => (
              <>
                ...
                <Transition
                  ...
                  leaveTo="opacity-0 "
                >
                  <Popover.Panel className="absolute right-0 z-10 mt-2 flex h-[100vh] w-full max-w-[18rem] transform flex-col overflow-y-auto bg-tm-grey bg-opacity-90 px-8 pb-40 shadow-inner backdrop-blur-md">
