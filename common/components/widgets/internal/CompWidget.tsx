...
export const CompWidget: React.FC<CompWidgetProps> = ({ value, text }) => {
  return (
    <div className="border-opacity-30 bg-opacity-[15%] flex w-full flex-row items-baseline rounded-md border-black bg-black px-4 py-2">
      <div className="text-opacity-95 flex flex-col gap-y-1 text-white">
