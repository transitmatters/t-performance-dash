...
// 16rem (shadcn's default) read as cramped with our icon + line-dot + chevron density; 18rem
// matches the roomier end of real dashboard sidebars (Linear, Vercel) without turning into a drawer.
