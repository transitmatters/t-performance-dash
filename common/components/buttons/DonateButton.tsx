  ...
  return (
    <StarBorder speed="10s">
      <Link
        ...
        className="rounded-mdring-white group bg-tm-red flex w-full cursor-pointer justify-start gap-x-2 rounded-md hover:bg-white focus:ring-1 focus:outline-hidden md:justify-start"
      >
