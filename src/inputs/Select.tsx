...
const Select: React.FC<SelectProps> = ({ options, optionComparator, onChange, defaultLabel = "", value, className }) => {
    ...
    return (
        <div className={classNames('select-component', className,  optionValues.length === 0 && 'disabled')}>
            <select
                ref={elementRef}
