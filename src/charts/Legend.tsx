...
export function Legend() {
  return (
    <div className="legend">
      ...
      <p>
        <span className="legend-dot twenty-five-percent"></span> {'>25% longer than benchmark'}
      </p>
      <p>
        <span className="legend-dot fifty-percent"></span> {'>50% longer than benchmark'}
      </p>
      <p>
        <span className="legend-dot hundred-percent"></span> {'>100% longer than benchmark'}
      </p>
      <p>
